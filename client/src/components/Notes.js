...
function NotesPage() {
  ...
  const [deleteDialogOpen, setDeleteDialogOpen] = React.useState(false); // new
    ...
    >
          ...
          <List>
            {filteredNotes.map((note) => (
              ...
              >
                ...
                <IconButton
                  edge="end"
                  onClick={(e) => handleMenuClick(e, note._id)}
      ...
      <Dialog open={addDialogOpen} onClose={() => setAddDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          ...
          <Button variant="contained" onClick={handleAddNote}>Add</Button>
        </DialogActions>
      </Dialog>
      ...
      <Menu anchorEl={anchorEl} open={open} onClose={handleMenuClose}>
        <MenuItem onClick={() => handleEditNote(notes.find((n) => n._id === menuNoteId))}>
          Edit
        </MenuItem>
      ...
      {/* Sort Menu */}
      <Menu anchorEl={sortAnchorEl} open={sortOpen} onClose={() => setSortAnchorEl(null)}>
        <MenuItem onClick={() => handleSort("recent")}>Recently created</MenuItem>
        <MenuItem onClick={() => handleSort("oldest")}>Oldest first</MenuItem>
        <MenuItem>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
            <Typography variant="body2">Filter by Date Range</Typography>
            <TextField
              type="date"
              size="small"
            ...
            />
            <Button variant="contained" size="small" onClick={() => handleSort("range")}>
              Apply
            </Button>
          </Box>
        </MenuItem>
